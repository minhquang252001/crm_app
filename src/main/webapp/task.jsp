            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="/testservlet/task-add" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    <c:forEach var="data" items="${listTable}">
                                        <tr>
                                            <td>${data.id }</td>
                                            <td>${data.name}</td>
                                            <td>${data.job_id}</td>
                                            <td>${data.menber_id}</td>
                                            <td>${data.start_date}</td>
                                            <td>${data.end_date}</td>
                                            <td>${data.status_id}</td>
                                            <td>
                                                <a href="/testservlet/task-update?id=${data.id}" id="btn-update" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="#" id-task="${data.id}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
