                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="role-name" type="text" name="role-name" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="role-desc" type="text" name="role-desc" placeholder="Mô tả" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a href="#" id="btnadd" type="submit" class="btn btn-success">Add Role</a>
