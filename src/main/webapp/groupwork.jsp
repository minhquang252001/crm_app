...
<body>
                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="data" items="${jobs}">
                                        <tr>
                                            ...
                                            <td>${data.end_date}</td>
                                            <td>
                                                <a href="/testservlet/groupwork-update?id=${data.id}" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                                <a href="#" id-groupwork="${data.id}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
    ...
    <script type="text/javascript" src="js/groupworkDelete.js"></script>
    <script>
