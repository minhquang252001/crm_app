...
<body>
                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="data" items="${listMenber }">
                                    	 <tr>
                                            ...
                                            <td>
                                                <a href="/testservlet/user-update?id=${data.id}" idUser="${data.id}" class="btn btn-sm btn-primary btn-sua">Sửa</a>
                                                <a href="#" idUser="${data.id}" class="btn btn-sm btn-danger btn-xoa">Xóa</a>
                                                <a href="user-details.html" class="btn btn-sm btn-info btn-xem">Xem</a>
                                            </td>
                                        </tr>
                                    </c:forEach>                                        
                                    </tbody>
    ...
    <script type="text/javascript" src="js/user-delete.js"></script>
