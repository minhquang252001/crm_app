...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <input type="text" id="roleId" name="roleId" class="form-control form-control-line" value="${role.id}" style="display: none;" />
                                <div class="form-group">
                                    <label class="col-md-12">Tên Quyền</label>
                                    <div class="col-md-12">
                                        <input type="text" id="roleName" name="roleName" placeholder="namee"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="roleDesc" name="roleDesc" placeholder="desc"
                                         class="form-control form-control-line" value="${role.desc}" />
                                    </div>
                                </div>
                                                    
                                <div class="form-group">
                                    <div class="col-sm-12">
                                     <a href="#" id="btn-update" type="submit" class="btn btn-success">Update Role</a>
    ...
    <script type="text/javascript" src="js/roleUpdate.js"></script>
</body>
