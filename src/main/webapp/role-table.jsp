...
<body>
                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tr>
                                            ...
                                            <td>${data.desc}</td>
                                            <td>
                                                <a href="/testservlet/role-update?id=${data.id}"  id-role="${data.id}" class="btn btn-sm btn-primary btn-sua">Sửa</a>
    ...
    <script type="text/javascript" src="js/roleDelete.js"></script>
    <script>
